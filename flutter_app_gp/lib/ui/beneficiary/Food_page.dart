...
class _FoodPageState extends State<FoodPage> {
  ...
  void initState() {
    ...
    // getUserDetails();
    _userDetails.add(UserDetails(1, "Restaurant", "assets/food.jpg"));
    _userDetails.add(UserDetails(2, "Cafe", "assets/coffee.jpg"));
    _userDetails.add(UserDetails(3, "Cafe2", "assets/library.jpeg"));
  }
            ...
            itemBuilder: (BuildContext ctx, index) {
              return Container(
                  ...
                  child: Column(children: <Widget>[
                    ...
                    Text(
                      _userDetails[index].serviceName,
                      style: TextStyle(
                          color: Colors.black,
                          fontSize: 18,
