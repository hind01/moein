...
class ProfileBeneficiaryPage extends StatefulWidget {
  @override
  _ProfileBeneficiaryPageState createState() =>
      new _ProfileBeneficiaryPageState();
}

class _ProfileBeneficiaryPageState extends State<ProfileBeneficiaryPage> {
  @override
  Widget build(BuildContext context) {
    return new Scaffold(
