...
class SignUpClassState extends State<SignUp> {
  ...
  var firstinput='',secondinput='',myerror='',myProvider,verificationId;
      ...
      body: Container(
        child: SingleChildScrollView(
          child: new Column(
            ...
            children: <Widget>[
              Padding(padding: EdgeInsets.only(top: 40,bottom: 20),child: Center(
                child: Text(
                  "Beneficiary",
                  style: TextStyle(
                      fontSize: 25,
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Icon(Icons.account_circle_outlined,textDirection: TextDirection.rtl,),

                        // labelStyle:  GoogleFonts.almarai( fontWeight: FontWeight.bold,color: HexColor('#8F9BB3'),fontSize:mobileselc? 25.sp:10.sp,),
                        suffixIcon:mobilecheck ? null: Container(
                          child: Icon(Icons.error,color: HexColor('#0095FF'),),
                        ),
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    counterText: '',
                    counterStyle: TextStyle(fontSize: 0),
                    prefixIcon: Icon(Icons.credit_card_rounded,textDirection: TextDirection.rtl,),
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    counterText: '',
                    counterStyle: TextStyle(fontSize: 0),
                    prefixIcon: Icon(Icons.mail,textDirection: TextDirection.rtl,),
              ...
              new Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: 'Password*',
                    prefixIcon: InkWell(
                      child: Icon(seepass ? Icons.lock_outline:Icons.lock_open,textDirection: TextDirection.rtl,),
                      onTap: (){
                        setState(() {
                          if (seepass==false)
                            seepass=true;
                    ...
                    suffixIcon:passcheck ? null: Container(
                      child: Icon(Icons.error,color: HexColor('#0095FF'),),
                    ),
                    enabled: true,
